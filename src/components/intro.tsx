...
export const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        A passionate web developer specializing in modern Nest.js and Next.js
        applications, with a strong interest in AI and machine learning
        technologies.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 100 }}
      ...
      >
        ...
        <Button variant="outline" size="icon" asChild>
          <Link
            href="https://github.com/adnanfito"
            aria-label="Github"
            target="_blank"
          >
